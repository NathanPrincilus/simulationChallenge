...
**Calculation:**
- If heads (50% probability): $30,000 × 1.5 = $45,000
- If tails (50% probability): $30,000 × 0.6 = $18,000
...
# Create a more meeting-friendly visualization: Box plot with histogram
fig, axes = plt.subplots(2, 1, figsize=(10, 7), 
                         gridspec_kw={'height_ratios': [2, 1]},
                         sharex=True)

# Top: Box plot
box_parts = axes[0].boxplot([final_balances], vert=True, patch_artist=True, 
                             widths=0.6, showmeans=True)
box_parts['boxes'][0].set_facecolor('lightblue')
box_parts['boxes'][0].set_alpha(0.7)

# Add reference line for initial buy-in
axes[0].axhline(y=30000, color='red', linestyle='--', linewidth=2, 
                label='Initial Buy-in ($30,000)', alpha=0.8)
axes[0].set_ylabel('Final Account Balance ($)', fontsize=12, fontweight='bold')
axes[0].set_title('Distribution of Final Balances: 100 Simulations', 
                  fontsize=14, fontweight='bold', pad=15)
axes[0].grid(True, alpha=0.3, axis='y')
axes[0].legend(fontsize=10, loc='upper left')
axes[0].yaxis.set_major_formatter(plt.FuncFormatter(lambda x, p: f'${x/1000:.0f}K'))

# Bottom: Histogram with counts
n, bins, patches = axes[1].hist(final_balances, bins=20, edgecolor='black', 
                                 alpha=0.8, color='steelblue')
axes[1].axvline(x=30000, color='red', linestyle='--', linewidth=2, alpha=0.8)
axes[1].set_xlabel('Final Account Balance ($)', fontsize=12, fontweight='bold')
...
print(f"P(final ≤ $30,000): {1 - prob_above_30k:.3f}")
